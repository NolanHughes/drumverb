...
product_list = [
  [ "Ludwig Supraphonic", "A kick ass snare drum", 250, "https://images.reverb.com/image/upload/s--4hiZ4HXM--/a_exif,c_limit,e_unsharp_mask:80,f_auto,fl_progressive,g_south,h_1600,q_80,w_1600/v1530041709/wvvn1qp1nksxps7bvijb.jpg" ],
  [ "Ludwig Black Beauty", "A kick ass snare drum", 500, "https://images.reverb.com/image/upload/s--Nl64Y4UW--/a_exif,c_limit,e_unsharp_mask:80,f_auto,fl_progressive,g_south,h_620,q_90,w_620/v1522164558/fjurmgnly5opy3rawgxa.jpg" ],
  ...
  [ "Ludwig Acrolite", "A kick ass snare drum", 150, "https://images.reverb.com/image/upload/s--2t_K9848--/a_exif,c_limit,e_unsharp_mask:80,f_auto,fl_progressive,g_south,h_620,q_90,w_620/v1439584940/ooocarjizlnh55oisjk9.jpg" ],
...
product_list.each do |title, description, price, image_url|
  Product.create( title: title, description: description, price: price, image_url: image_url )
end
